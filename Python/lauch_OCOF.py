...
class Stage:
    ...
    def burn_mass(self, standard_gravity, ratio: float = 1.0, duration: float = 1.0):
        ...
        if isinstance(self.specific_impulse, int):
            ...
            isp = self.specific_impulse[0] + (self.specific_impulse[1] - self.specific_impulse[0]) * ratio
        else:
            isp = 0
